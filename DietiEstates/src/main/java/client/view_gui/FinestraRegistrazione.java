...
public class FinestraRegistrazione extends JFrame {
    ...
    private void addHeader() {
     ...
     private void addLabelsAndFields(Controller c) {
        ...
        labelVerifyNome.setBounds(120, 140, 150, 20);
        ...
        labelVerifyCognome.setBounds(390, 140, 198, 20);
        ...
        validationLabel.setBounds(390, 187, 150, 30);
        ...
        labelConfermaTelefono.setBounds(120, 233, 230, 25);
    ...
    private void validateName(Controller c) {
        ...
        if (c.isValidNome(text)) {
            ...
            labelVerifyNome.setText("<html>❌ Nome troppo corto</html>");
    ...
    private void validateSurname(Controller c) {
        ...
        if (c.isValidNome(text)) {
            ...
            labelVerifyCognome.setText("<html>❌ Cognome troppo corto</html>");
    ...
    private void validateEmail(Controller c) {
        ...
        if (c.isValidEmail(text)) {
            validationLabel.setText("<html>✔️ Email valida</html>");
            validationLabel.setForeground(Color.GREEN);
            controllo[2] = true;
        } else {
            validationLabel.setText("<html>❌ Email non valida</html>");
    ...
    private void validatePhone(Controller c) {
        ...
        if (c.isValidNumero(text)) {
            ...
            labelConfermaTelefono.setText("<html>❌ Numero di telefono non valido</html>");
    ...
    private void validateConfirmPassword(Controller c) {
        if (c.verifyPassword(passwordField.getPassword(), passwordFieldConferma.getPassword())) {
            lblCheckPassword.setText("<html>✔️ Le password coincidono</html>");
            lblCheckPassword.setForeground(Color.GREEN);
            combacia = true;
        } else {
            lblCheckPassword.setText("<html>❌ Le password non coincidono</html>");
