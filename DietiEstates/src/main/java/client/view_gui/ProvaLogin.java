...
public class ProvaLogin extends JFrame {
	...
	public ProvaLogin(Controller c) {
		...
		contentPane.setBackground(new Color(40, 132, 212));
		...
		panel.setPreferredSize(new Dimension(getWidth(), 160));
		contentPane.add(panel);
		panel.setLayout(new BorderLayout(0, 0));
		
		ImageIcon iconLogo = new ImageIcon(getClass().getResource("/logopngwhite.png"));
		...
		gblPanel1.rowHeights = new int[]{33, 0, 367, 0};
		...
		lblSottoTitolo.setFont(new Font("Dialog", Font.ITALIC, 25));
